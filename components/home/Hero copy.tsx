...
export function Hero() {
  return (
    <section className="relative pt-16 overflow-hidden" style={{ background: '#1a1564' }}>
      {/* Gradient & glow */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a1564] via-[#1e1fa8]/60 to-[#0f2c6e]" />
        <div className="absolute -top-32 right-0 w-[500px] h-[500px] rounded-full bg-[#3730d0]/25 blur-[100px]" />
